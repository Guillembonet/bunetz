...
func Navigation() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<nav x-data=\"{ isOpen: false }\" class=\"bg-white shadow dark:bg-gray-800\"><div class=\"container px-6 py-4 mx-auto\"><div class=\"lg:flex lg:items-center\"><div class=\"flex items-center justify-between\"><a href=\"#\"><svg class=\"w-auto h-6 sm:h-7\" width=\"100\" height=\"100\" viewBox=\"0 0 100 100\" xmlns=\"http://www.w3.org/2000/svg\"><style>\n                                .background { fill: #4A90E2; }\n                                .letter { fill: #ffffff; font-family: Arial, sans-serif; font-size: 72px; font-weight: bold; }\n                            </style><circle class=\"background\" cx=\"50\" cy=\"50\" r=\"50\"></circle> <text class=\"letter\" x=\"50%\" y=\"50%\" text-anchor=\"middle\" alignment-baseline=\"central\" dy=\".1em\">B</text></svg></a><!-- Mobile menu button --><div class=\"flex lg:hidden\"><button x-cloak @click=\"isOpen = !isOpen\" type=\"button\" class=\"text-gray-500 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 focus:outline-none focus:text-gray-600 dark:focus:text-gray-400\" aria-label=\"toggle menu\"><svg x-show=\"!isOpen\" xmlns=\"http://www.w3.org/2000/svg\" class=\"w-6 h-6\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\" stroke-width=\"2\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M4 8h16M4 16h16\"></path></svg> <svg x-show=\"isOpen\" xmlns=\"http://www.w3.org/2000/svg\" class=\"w-6 h-6\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\" stroke-width=\"2\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M6 18L18 6M6 6l12 12\"></path></svg></button></div></div><div x-cloak :class=\"[isOpen ? &#39;translate-x-0 opacity-100 &#39; : &#39;opacity-0 -translate-x-full&#39;]\" class=\"absolute inset-x-0 z-20 flex-1 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center lg:justify-between\"><div class=\"flex flex-col text-gray-600 capitalize dark:text-gray-300 lg:flex lg:px-16 lg:-mx-4 lg:flex-row lg:items-center\">")
		...
		for _, link := range NavigationLinks {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" class=\"mt-2 transition-colors duration-300 transform lg:mt-0 lg:mx-4 hover:text-gray-900 dark:hover:text-gray-200\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/navigation.templ`, Line: 33, Col: 166}
			}
